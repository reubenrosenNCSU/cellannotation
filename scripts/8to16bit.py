...
# Example usage
#input_directory = '/home/greenbaumgpu/Reuben/js_annotation/uploads'
#output_directory = '/home/greenbaumgpu/Reuben/js_annotation/input'

if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python normalize.py <input_file> <output_dir>")
        sys.exit(1)
